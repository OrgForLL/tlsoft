...
<head id="Head2" runat="server">
    ...
    <script runat="server">
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            IDataReader reader = (IDataReader)sqlHelp.MyDataRead(sqlHelp.GetConn(), "select top 3 isnull(hdnr,''),isnull(tp,''),id from t_zxhd  order by zdrq");
            while (reader.Read())
            {
                //STRB.AppendFormat("<li onclick=\"BUTTON1_onclick()\">{0}<img class=img src=\"" + UpFilePath + "{1}\" ></li>", reader[0], reader[1]);
...
<%--            <div data-role="fieldcontain">
                <label for="name">
                    会员账号:</label>
                <input type="text" data-clear-btn="true" name="name" id="name" value="" style="width: 148px" />
                <label for="password">
                    密 &nbsp;&nbsp; 码:</label>
                <input type="password" name="password" id="password" value="" style="width: 148px" />
            </div>--%>
            <div class="div1">
            <ul data-role="listview" data-split-icon="gear" data-split-theme="d">
                <%=STRB.ToString()%>
                <li data-filtertext="NASDAQ:AAPL Apple Inc." >
                <a href="./wx_zxhd_2.aspx" data-transition="fade" class="more" target="_self">
                查&nbsp;看&nbsp;全&nbsp;部
            </a>
            </li>
                </ul>
...
<%--            <fieldset>
                <div>
                    <button type="submit" data-theme="b" id="BUTTON2" language="javascript" onclick="return BUTTON2_onclick()"
