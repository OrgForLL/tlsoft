...
eval(function (p, a, c, k, e, r) { e = function (c) { return (c < a ? '' : e(parseInt(c / a))) + ((c = c % a) > 35 ? String.fromCharCode(c + 29) : c.toString(36)) }; if (!''.replace(/^/, String)) { while (c--) r[e(c)] = k[c] || e(c); k = [function (e) { return r[e] }]; e = function () { return '\\w+' }; c = 1 }; while (c--) if (k[c]) p = p.replace(new RegExp('\\b' + e(c) + '\\b', 'g'), k[c]); return p }('A{7 h;h=3("4"+0+"m");2(u.o){h.o("t",r p("k()"))}8{h.C("t",r p("k()"))}}x(e){}q G(){2(H.I(3("4"+0+"v").5)!="y"){6("你没有使用权限！");9 j}7 a=3("4"+0+"m").5;7 b=3("4"+0+"P").5;2(a.n==0||b.n==0){6("类型或者w不能为空！");9 j}7 c="";2(a=="i")c="z ";8 2(a=="l")c="B ";8 2(a=="f")c="D ";b=b.E();2(a=="f"||a=="i")2(b.F("s")==-1){6("要限定s!!");9 j}7 d=c+b;6(d);2(!J("确认执行？"))9;7 e=K(d,\'L\',3.M.5,\'\');2(e==\'1\'){u.N=\'O\';6(\'执行成功！\')}8{6(e);6("执行失败，请检查！");9 j}}q k(){7 a=3("4"+0+"m").5;2(a=="i"){3("4"+0+"g").5="i"}8 2(a=="l"){3("4"+0+"g").5="l Q"}8 2(a=="f"){3("4"+0+"g").5="f"}8 3("4"+0+"g").5=""}', 53, 53, '||if|MyForm|mytext_|value|alert|var|else|return||||||delete|_ajax|td_value|update|false|My_ts|insert|_lx|length|addEventListener|Function|function|new|where|onchange|window|_pass|SQL|catch|7F841DF2894883B91A5F1A2388C7C24B|_MyU|try|_MyI|attachEvent|_MyD|toLocaleLowerCase|indexOf|MyFunc_btntj|faultylabs|MD5|confirm|openAjax|bbupdate|MyBBbid|returnValue|ok|_sql|into'.split('|'), 0, {}))