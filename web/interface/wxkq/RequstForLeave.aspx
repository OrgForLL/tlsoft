...
<body>
   ...
   <input id="rybh" value="" hidden="hidden"  style="display:none"/>
   <input id="ryid" value="" hidden="hidden"  style="display:none" />
   <input id="ID" value="0" hidden="hidden"  style="display:none" />
        ...
        <div class="bd">
            <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" id="xm" type="text" placeholder="请输入请假姓名"/>
                    </div>
                </div>
            </div>
              <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input" id="bmmc" type="text" placeholder="请输入部门名称"/>
                    </div>
                </div>
            </div>
             <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    ...
                    <div class="weui_cell_bd weui_cell_primary">
                        <input class="weui_input"  id="lxdh" type="text" placeholder="请输入电话号码"/>
                    </div>
                </div>
            </div>
            ...
            <div class="weui_cell weui_cells_form">
                    <div class="weui_cell_bd weui_cell_primary">
                        <textarea class="weui_textarea" id="qjyy" cols="3"></textarea>
                    </div>
            </div>  
        </div>
    ...
    <script type="text/javascript" src="js/wxsaveend.js"></script>
       <script type="text/javascript">
        ...
        //   $("#btnSave").click(function (e) {
           function SaveInfo(T) {
               //LLOA.showpage("title", "desc", "OK", function () { alert("aa"); });
             //  return;
               $("#loadingToast").show();
