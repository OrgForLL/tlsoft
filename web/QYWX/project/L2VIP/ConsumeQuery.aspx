...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (clsWXHelper.CheckUserAuth(ConfigKeyValue, "vipid"))
        {
            ...
            {
                string str_sql = @"select kh from yx_t_vipkh where ID=@vipid";
...
<head>
    ...
    <title></title>
    <link type="text/css" rel="stylesheet" href="<%= VIP_resPath %>/css/LeePageSlider.css" />
    <link type="text/css" rel="stylesheet" href="<%= VIP_resPath %>/css/font-awesome.min.css" />
    <style type="text/css">
        body {
            font-size: 16px;
        ...
        .header .line {
            width:100%;
            height:4px;
            background-image:url(<%= VIP_resPath %>/img/vipweixin/top-line.png);
...
<body>
    ...
    <div class="wrap-page">
        ...
        <div class="page page-not-header-footer page-right" id="detail">
            <ul class="detailul">
                <!--<li class="ditem">
                    <div class="clothesimg backimg" style="background-image:url(<%= VIP_resPath %>/img/storesaler/1.png);"></div>
                ...
                <li class="ditem">
                    <div class="clothesimg backimg" style="background-image:url(<%= VIP_resPath %>/img/storesaler/6.png);"></div>
                    <div class="clothes-info">
                        <p class="title">5QJKSKDSA</p>
                        <p class="cmys"><p class="cmys"><strong>尺码：</strong>L&nbsp;&nbsp;&nbsp;<strong>颜色：</strong>黑色</p>
                        <p class="price">￥1245.00</p>
                    </div>
                </li>
                <li class="ditem">
                    <div class="clothesimg backimg" style="background-image:url(<%= VIP_resPath %>/img/storesaler/6.png);"></div>
                    <div class="clothes-info">
                        <p class="title">商品货号：5QJKSKDSA</p>
                        <p class="cmys"><p class="cmys"><strong>尺码：</strong>L&nbsp;&nbsp;&nbsp;<strong>颜色：</strong>黑色</p>
                        <p class="price">￥1245.00</p>
                    </div>
                </li>
    ...
    <script type="text/javascript">
        ...
        function LoadZBData() {
            ...
            $.ajax({
                url: "FWHUserCenterCore.aspx?ctrl=LoadConsumeRecords",
                type: "POST",
                dataType: "text",
                data:{vipkh:vipkh},
                timeout: 10000,
        ...
        function ShowDetail(djid) {
            showMessage("loading", "正在加载...");
            $.ajax({
                url: "FWHUserCenterCore.aspx?ctrl=LoadConsumeDetail",
                type: "POST",
                dataType: "text",
                data:{djid:djid},
                timeout: 10000,
                ...
                success: function (datas) {
                    if (datas == "") {
                        ...
                        for (var i = 0; i < len; i++) {
                            var row = data.rows[i];
                            var imgsrc = row.urladdress == "" ? "<%= VIP_resPath %>/img/L2VIP/lilanzlogo2.jpg" : "http://webt.lilang.com:9001" + row.urladdress.replace("..", "");
