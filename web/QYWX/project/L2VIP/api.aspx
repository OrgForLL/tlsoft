...
<script runat="server">
    ...
    private void ResponseMsg()
    {
        ...
        {
            if (px.GetElementsByTagName("Event")[0].InnerText == "CLICK")
            {
            ...
            if (px.GetElementsByTagName("Event")[0].InnerText == "subscribe" || px.GetElementsByTagName("Event")[0].InnerText == "SCAN")
            {
                ...
                { 
                    ...
                    if (clsWXHelper.CheckResult(ConfigKey, rContent) == true)
                    {
                        ...
                        if (cUserID > 0)
                        {
                            //if (CodeValue == PaperGameID) GetPrize();
                            //else if (CodeValue == "10001" || CodeValue == "10003" || CodeValue == "10004" || CodeValue == "10005") GetGameCount(CodeValue);
                            //else backGetToken();      //判断中奖逻辑                             
                ...
                backText("感谢您关注L2时尚男装官方服务号，点击右下角“俱乐部”立刻注册成为微会员，线下会员亦可立即同步积分哦！");
            }
...
//            }
    ...
    {
        clsLocalLoger.WriteInfo(string.Concat("[L2时尚男装] ",strMemo));
    }
