...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e) {
        if (clsWXHelper.CheckQYUserAuth(true))
        {
            ...
            ERP_WebPath = clsConfig.GetConfigValue("ERP_WebPath");
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../res/css/WeiXinCard/increateV3.css" />
    </head>
    <body>
        ...
        <script type="text/javascript" src="../../res/js/WeiXinCard/promise.js"></script>
        <script type="text/javascript" src="../../res/js/WeiXinCard/increateV3.js"></script>
        <script type="text/javascript">
            var ERP_WebPath = "<%=ERP_WebPath%>";
