            ...
            else
            {
                ...
                using (LiLanzDALForXLM sqlhelper = new LiLanzDALForXLM(conn))
                {
                    ...
                    if (strInfo != "" || dt.Rows.Count == 0)
                    {
                        ...
                        Response.Redirect("ListAll.aspx?ClearLocal=1");
                        return;
                    }
...
<body>
    <div id="page">        
        <div id="page_nr">
            ...
            <div class="dqArea" onclick="return;"> <%--SetXg()--%>
            ...
            <div class="btnPanel">
                <img alt="我要报名" src="../../res/img/StylishMen/btnGotoSignin.jpg" onclick="javascript:window.location.href='SigninAll.aspx';" />
    ...
    <script id="panel-temp" type="text/html">
        {{each List as mh}}            
            <div class="imgPanel" openid="{{mh.openid}}">                
                ...
                <span class="sf">{{mh.Provinces}}</span>
...
<script>
    ...
    function AutoSetArea() {
        ...
        if (AreaID == "") {
            window.location.href = "ListAll.aspx?aid=" + aid;
        }        
    }
    ...
    function gotoArea(bs) {
        ...
        if (bs == 1) {
            ...
            window.location.href = "ListAll.aspx?aid=" + $("#selArea").val();
        } else {
            var selArea = "";
            if ($("#selArea").val() != null && $("#selArea").val() != "") selArea = $("#selArea").val();
            else if (AreaID != "") selArea = AreaID;
            window.location.href = 'VotedSortAll.aspx?AreaID=' + selArea;
        }
    }
    ...
    function SetClickImgPanel() {
        ...
        window.location.href = "ShowInfoAll.aspx?bs=1&mbopenid=" + openid;
    }
