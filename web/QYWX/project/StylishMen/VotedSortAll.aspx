        ...
        <table class="table-name">
            <thead>
                <tr>
                    ...
                    <th style="width:60%;">参赛选手</th>
                    <th style="width:20%;">票  数</th>
                </tr>
            </thead>
        </table>
        <div id="table-list">
...
<%--                    <tr>
    ...
    <script id="list-temp" type="text/html">
        {{each List as mh i}}           
            <tr>
                <td style="width:20%;font-size: 30px;" rowspan="2">{{if i<=2}}<img alt="" src="../../res/img/StylishMen/top{{i+1}}.jpg" style="height: 30px;" />{{else}} {{i+1}} {{/if}}</td>
                <td style="width:80%;border-bottom:0;color:#c0c0c0;text-align:left;" colspan="2">{{mh.Provinces}}-{{mh.StoreName}}</td>
            </tr>        
            <tr>
                <td style="width:60%;text-align:left;">№{{mh.ID}}.{{mh.Cname}}</td>
                <td style="width:20%;">{{mh.TokenCount}}票</td>
            </tr>
        {{/each}}
    </script>
