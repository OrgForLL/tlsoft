...
//: this(ConfigurationManager.ConnectionStrings["Conn"].ConnectionString)
        ...
        public SqlDbHelper(string cid)
        {
            this.connectionString = ConfigurationManager.ConnectionStrings["Conn_"+cid].ConnectionString;
        }
        /// <summary>
        /// 执行一个查询，并返回结果集
        /// </summary>
        ...
        public int SqlTrans(string sql,  SqlParameter[] parameters)
        {
            using (SqlConnection Connection = new SqlConnection(connectionString))
            {
                Connection.Open();
