...
<body>
        ...
        <div class="page page-not-header">
            <ul class="pointsul" id="pointsul">
                <!--<li class="title">
                    ...
                    <span class="t1">赚取积分<span>560</span></span>
                    <span class="t1">兑换积分<span>0</span></span>
                </li>
                <li>
                    <div class="pmark">
                        <p>积分说明</p>
                        <p>2016-01-01 12:34:00</p>
                    </div>
                    <div class="pval">+140</div>
                </li>
                <li>
                    <div class="pmark">
                        <p>积分说明</p>
            ...
            <div class="hint center-translate">Sorry,您暂时无相关利豆记录!</div>
        </div>
    </div>
    <!--加载提示层-->
    <section class="mask">
    ...
    <script type="text/javascript">
        ...
        function loadData() {
            ...
            $.ajax({
                url: "../../WebBLL/FWHUserCenterCore.aspx?ctrl=LoadUserPoints",
                type: "POST",
                dataType: "text",
                data: { vipid: "<%=vid%>" },
                timeout: 10000,
                ...
                success: function (result) {
                    if (result.indexOf("Error:") > -1)
                        ...
                        if (data != "") {
                            ...
                            var titleTemp = "<li class='title'><span class='month'>#month#</span><span class='t1'>赚取<span>#yf_in#</span></span><span class='t1'>兑换<span>#yf_out#</span></span>";
