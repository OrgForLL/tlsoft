...
<script runat="server"> 
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (clsWXHelper.CheckUserAuth(ConfigKeyValue, "openid"))
        {
            ...
            {
                //clsLocalLoger.WriteInfo("已有VIPID：" + Convert.ToString(Session["vipid"]));
...
<body>
    <div class="wrap-page">
        <div class="logo">
            <div class="logodiv"><img src="../../res/img/vipweixin/lllogo6.png" alt="" /></div>
        </div>
        <div class="headimg">
        ...
        <div class="btns">
            <div id="binging" class="btn-item animated bounceIn" onclick="window.location.href='vipBinging_v3.aspx'">我已经是会员</div>
            <div id="inforeg" class="btn-item animated bounceIn delay" onclick="window.location.href='vipInfoRegV1.aspx'">申请成为会员</div>
            <div class="hints">
                <div class="title">
                    <div class="line"></div>
                    <p class="hh">温馨提示</p>
                </div>
                <p class="remark">1、如果您已经是利郎会员，请点击第一个按钮，关联您的线下会员卡。</p>
                <p class="remark">2、如果您还不是利郎会员，请点击第二个按钮，一分钟成为利郎尊贵会员,赶快行动吧！</p>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (configkey == '7') {
                document.querySelector(".logodiv img").setAttribute('src', '../../res/img/EasyBusiness/qswlogo.jpg');
                document.getElementById("binging").onclick = function() {
                    window.location.href='vipBinging.aspx';
                };
                document.getElementById("inforeg").onclick = function() {
                    window.location.href='vipInfoReg.aspx';
                };
            }
        });
    </script>
