...
<script runat="server">
    public string wxHeadimgurl = "../../res/img/vipweixin/headImg.jpg";  
    public string cid = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (clsWXHelper.CheckUserAuth(ConfigKeyValue, "openid"))
        {
            ...
            {
                sql = @"select wxHeadimgurl,wxNick from wx_t_vipBinging  where wxopenid=@openid ";
                para.Add(new SqlParameter("@openid", openid));
                using (LiLanzDALForXLM dal = new LiLanzDALForXLM(DBConStr))
                {
    ...
    <div class="content">
        ...
        <div class="divContent">
             <form id="form1" runat="server">
                <div class="userinfo">
                    <div class="avatar" style="background-image:url('<%=wxHeadimgurl %>');background-size:cover;"></div>
                    <span class="username"></span>
                </div>
                <div class="mod_input ">
                    <i class="fa fa-user icon"></i>
                    <input type="text" name="VipNo" class="flex_box" id="VipNo" runat="server"
                        onkeydown="return mySubmit(event);" placeholder="请输入vip卡号" />
                ...
                <div class="registered">
                    <a  href="vipInfoRegV1.aspx" class="btn">会员注册</a>
                </div>
            </form>
        </div>
        <div class="info-wrap">
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        ...
        $(".sendcode_btn").click(function () {
            ...
            var vipkh = $("#VipNo").val();
//            if (phone.length != 11) {
//                LeeJSUtils.showMessage("error", "请输入11位手机号码");
//                showts("请输入11位手机号码");
//                return;
//            }
            ...
            setTimeout(function () {
                $.ajax({
                    ...
                    cache: false,
                    timeout: 10 * 1000,
                    data: { kh: vipkh, code: "<%=msgCode %>" },
                    contentType: "application/x-www-form-urlencoded; charset=utf-8",
                    url: "vipInfoRegCoreV1.aspx?ctrl=senbindcode",
            ...
            if (codeVal == "<%=msgCode %>") {
                setTimeout(function () {
                    $.ajax({
                        ...
                        contentType: "application/x-www-form-urlencoded; charset=utf-8",
                        url: "vipInfoRegCoreV1.aspx?ctrl=bindvip",
                        success: function (msg) {
                            console.log(msg);
                            var rt = JSON.parse(msg);
                            if (rt.code == "200") {
