...
<body>
    <div class="divContent">
        ...
        <div>
            <a href="vipInfoRegV1.aspx?cid=3&sid=5>" class="btn">VIP会员申请</a>
        </div>
        <div id="bottom">
            <h1>
                利郎信息技术部提供技术支持</h1>
...
//                        swal("申请成功！");
//                        setTimeout(function () {
//                            window.location.href = 'vipWaiting.aspx?gourl=NewUserCenter.aspx&title=个人中心';
//                        }, 2000);
                        swal({
                            title: '利郎温馨提示 ',
                            text: "关联成功！",
