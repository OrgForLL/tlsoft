    ...
    public string resInfo(LeaveInfo leave)
    {
        ...
        string strSQL = @"  IF EXISTS (SELECT TOP 1 ID FROM wx_t_vipBinging WHERE wxOpenid=@openid AND VipID>0)
                              ...
                              ELSE
                               ...
                               ELSE
                                 BEGIN 
                                   DECLARE @VIPID INT;declare @khid int;declare @mdid int;
                                   ...
                                   begin
	                               INSERT INTO YX_T_Vipkh(khid,mdid,kh,xm,xb,csrq,yddh,jdrq,tbrq,klb,isjf) 
	                               VALUES (-1,0,@phone,@cname,@sex,@mybirthday,@phone,GetDate(),GetDate(),@wxVIPType,0)
                                   set @VIPID = @@identity 
                                   end
            ...
            if (eScal == "")
            {
                ...
                else
                {
                    ...
                    if (eScal1 == "")
                    {
                        ...
                        if (eScal2 == "")
                        {
                            //SendInfoWX("linwy", "您的粉丝【" + dt.Rows[0]["wxNick"] + "】已经关联了会员【" + dt.Rows[0]["xm"] + "】！");
