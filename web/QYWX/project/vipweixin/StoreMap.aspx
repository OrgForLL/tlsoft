...
<script runat="server">
	...
	private const string ConfigKey = "5";	//APPID 
    public string SharedLogo = "http://tm.lilanz.com/qywx/res/img/vipweixin/lilanzlogo1.jpg"; //分享图片
      ...
      //  SetIsDebugMode(); 
        ...
        using (LiLanzDALForXLM dal = new LiLanzDALForXLM(dbConn))
        {
            string strSQL = string.Concat(@"
                                            SELECT TOP 1 B.mdmc,D.addressInfo,D.Lat,D.Lng FROM t_mdb B 
       ...
       // transform(wgLat, wgLng, out mgLat, out mgLon);        //后经过测试，发现无须解码        
        ...
        clsWXHelper.WriteLog("0", "利郎男装_访客", Request.Url.AbsoluteUri, myIP, "访问周边位置_门店地图");
    }
