...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Repeater1.DataSource = wx.MenuByRole(2);
        Repeater1.DataBind();
    }
</script>
<html>
    ...
    <style type="text/css">
        * {
        ...
        .headimg {
            ...
            background-image: url(../../res/img/StoreSaler/vip6.jpg);
...
<body>
    <div class="container">
        <div class="top">
            ...
            <div class="userinfo">
                <p class="wxnick">官海文(店长)</p>
                <p class="wxnums">电 话：15260825009</p>
                <p class="wxnums">邮 箱：elilee@126.com</p>
            </div>
    ...
    <div class="qrmask">
        <div class="qrcon">
            <div class="headimg"></div>
            <p class="wxnick">李兴(店长)</p>
            <p class="wxnick area">门店：解放路嘉润洪直营店</p>
            <p style="text-align:center;margin:10px 0 30px 0;"><img src="../../res/img/StoreSaler/lilangcode.jpg" /></p>
            <div class="qrtxt">扫一扫上面的二维码图案<br/>就可以关注我啦！</div>
        </div>        
    </div>
        ...
        function switchMenu(order) {
            ...
            switch (order) {
                ...
                case 2:
                    ...
                    //break;
                case 3:
                    window.location.href = "usercenter2.aspx";
                    break;
                default:
