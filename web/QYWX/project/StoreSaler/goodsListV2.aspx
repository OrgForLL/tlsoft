...
<script runat="server">
    string mdid, mdmc, showType,RoleID;
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        {
            case "1":
                clsWXHelper.CheckQQDMenuAuth(23);    //检查菜单权限
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="html_container">
        ...
        <script type="text/html" id="page2">
            ...
            <input id="sphh" value="" type="hidden" />
            <div id="goodsDetail" class="wrap-page none">
                <div class="page page-not-header-footer">
                    ...
                    <div class="product-cminfo">
                     ...
                     <div class="product-sameStyle" style="display:none;">
                        <p class="title" onclick="loadOFBContent()"><span id="">商品意见</span><span class="float_r"> 》</span></p>
                     </div>
    ...
    <script type="text/javascript">
        ...
        function goodsList(){ 
            ...
            var stxt = $("[id$=keyword]").val().toUpperCase();
            $.ajax({
                url: "goodsListCoreV2.aspx?ctrl=goodsList",
                type: "post",
                dataType: "text",
        ...
        function goodsListSingle(scanResult,scanType) {
            ShowLoading("拼命加载中...", 5);
            $.ajax({
                url: "goodsListCoreV2.aspx?ctrl=goodsListSingle",
                type: "post",
                dataType: "text",
        ...
        function goodsfilter(scanResult,scanType){ //字段:值
            ShowLoading("拼命加载中...", 15);
            $.ajax({
                url: "goodsListCoreV2.aspx?ctrl=goodsfilter",
                type: "post",
                dataType: "text",
        ...
        function goodsDetail(scanResult,scanType,other){      
            ...
            $.ajax({
                url: "goodsListCoreV2.aspx?ctrl=goodsDetail",
                type: "post",
                dataType: "text",
                data: { showType:"<%=showType %>", mdid:"<%=mdid %>", scanResult:scanResult, scanType:scanType},
                cache: false,
        ...
        function goodsStock(scanResult,scanType){
            $.ajax({
                url: "goodsListCoreV2.aspx?ctrl=goodsStock",
                type:"post",
                dataType: "text",
                data: { showType:<%=showType %>,mdid:<%=mdid %>,scanResult:scanResult,scanType:scanType},
                catch: false,
                ...
                success:function (res){
                    if(res.indexOf("Error")>-1){
                     ...
                     //   var htmlStr="<p class='title'><span>库存信息</span>|<span>定量</span>|<span>销量</span>|<span>周转量</span>|<span>备货库存</span></p><ul>";
                        var sphh="";
                        if(obj.rows.length>0){
                            sphh=obj.rows[0]["sphh"].toString();
                            $("#sphh").val(obj.rows[0]["sphh"].toString());
                        }
		...
		function StockQuery(stockType,sphh){
            ...
            htmlStr="";
            $.ajax({
                url: "goodsListCoreV2.aspx?ctrl=selectGoodsStock",
                type:"post",
                dataType: "text",
        ...
        function loadSameType(){
          $.ajax({
                url: "goodsListCoreV2.aspx?ctrl=loadSameType",
                type:"post",
                dataType: "text",
                data: { showType:<%=showType %>,mdid:<%=mdid %>,sphh:$("#sphh").val()},
                catch: false,
                timeout: 10000,
                error: function(e){
                    HideLoading();				
        ...
        function goodsImg(scanResult,scanType){
            ...
            $.ajax({
                url: "goodsListCoreV2.aspx?ctrl=goodsImg",
                type:"post",
                dataType: "text",
                data: { showType:<%=showType %>,mdid:<%=mdid %>,scanResult:scanResult,scanType:scanType},
                catch: false,
