    ...
    <script type="text/javascript">
        ...
        function getRank(area, month) {
            ...
            $.ajax({
                ...
                success: function (data) { 
                    ...
                    window.scroll(0, 0);
                    for (var obj in data) {
                        $(".fans ul").append("<li><div><img src='" + data[obj]["avatar"] +
                                "' /></div><div class='name'>" + data[obj]["cname"] +
                                "</div><div class='count'>" + data[obj]["fans"] +
                                "</div><div class='trend' style='background-image:url(../../res/img/StoreSaler/no" + data[obj]["rownumber"] + ".png)'></div></li>");
                    }
                },
                error: function (XMLHttpRequest, textStatus, errorThrown) {
                    alert(errorThrown);
        ...
        $(".area").click(function () {
            ...
            switch (areaText) {
                ...
                case "province":
                    //returnMonth();
                    getRank("province", timeDm);
                    getMine("province", timeDm);
                    break;
                case "all":
                    //returnMonth();
                    getRank("all", timeDm);
