...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script id="datali_2" type="text/html">
        <li mdid="{{khid}}">
            <p class="data-item col4 underline" col="cgsl">{{khdm}}.{{if (khjc == "")}}{{khmc}}{{else}}{{khjc}}{{/if}}</p>
            <p class="data-item col15 num ">{{cgsl}}</p>
            <p class="data-item col15" col="xssl">{{xssl}}</p>
            <p class="data-item col15" col="xsje">{{xsje}}</p>
            <p class="data-item col15" col="wcl">{{wcl}}</p>
        </li>
            ...
            $.ajax({
                ...
                success: function (msg) {
                    if (msg.indexOf("Error:") == -1 && msg != "") {
                        ...
                        StaticCount("md",datas.sumCgsl,datas.sumXssl,datas.sumXsje,datas.Wcl);
        ...
        function gotoSearch() {
            ...
            if (roleID == "4") {
                if (ssid != "1" && ssid != "") {  
                    ...
                    if(CurrentSite!="md") filter.core.mdkhid = "";
                }
            }
            ShowSearchCaption(); 
