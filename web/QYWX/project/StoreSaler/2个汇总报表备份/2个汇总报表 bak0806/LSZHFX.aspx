        ...
        else if (roleID < 3 && roleID > 0)
        {
            ...
            using (LiLanzDALForXLM dal = new LiLanzDALForXLM(dbConn))
            {
                ...
                if (strInfo == "")
                {
                    ...
                    if (mdinfo.Length == 2) sbCompany.AppendFormat(optionBase, mdinfo[0], mdinfo[1], opselect, mdinfo[2]);
        ...
        <div class="page page-right" id="fiterpage">
            <div class="filtercontainer">
                ...
                <div class="farea floatfix" filter="kfbh">
                    ...
                    <div class="fitem" dm="all" style="height:60px;line-height:44px;">全部..</div>
