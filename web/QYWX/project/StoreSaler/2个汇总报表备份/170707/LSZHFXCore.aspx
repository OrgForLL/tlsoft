...
<script runat="server">
    ...
    public void GetCGData(string filterJSON) {
        ...
        using (LiLanzDALForXLM dal_dd = new LiLanzDALForXLM(DBConn)) {
            ...
            //clsLocalLoger.WriteInfo("LSZHFXCore-zmdfl" + zmdfl);
            //clsLocalLoger.WriteInfo("LSZHFXCore-khid" + khid);
            //clsLocalLoger.WriteInfo("LSZHFXCore-mdkhid" + mdkhid);
            //clsLocalLoger.WriteInfo("LSZHFXCore-lbid" + lbid); 
            if (errinfo == "")
            {
    ...
    public DataTable GetCG(string filterJSON,int cs) {
        ...
        filterStr = string.Concat(filterStr, " and md.khfl LIKE @zmdfl");
        paras.Add(new SqlParameter("@zmdfl", zmdfl));
    ...
    public void GetMDLSSQL(string filterJSON)
    {
        ...
        //WriteLog(_sql + "\r\n" + filterJSON);
        //clsLocalLoger.WriteInfo("_sq=" + _sql);        
        using (LiLanzDALForXLM dal = new LiLanzDALForXLM(LSDBConstr))
        {
            DataTable dt;            
            string errinfo = dal.ExecuteQuerySecurity(_sql, paras, out dt);
