...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Repeater1.DataSource = wx.MenuByRole(1);
        Repeater1.DataBind();
    }
</script>
    ...
    <style type="text/css">
        * {
        ...
        .top {
            width: 100%;
            height: 90px;
            /*background-image:-webkit-linear-gradient(top,#141414,#000);/*272b2e*/
        ...
        .headimg {
            ...
            background-image: url(../../res/img/StoreSaler/vip5.jpg);
    ...
    <div class="qrmask">
        <div class="qrcon">
            ...
            <p style="text-align: center; margin: 10px 0 30px 0;">
                <img src="../../res/img/StoreSaler/lilangcode.jpg" /></p>
            <div class="qrtxt">扫一扫上面的二维码图案<br />
                就可以关注我啦！</div>
        </div>
    </div>
