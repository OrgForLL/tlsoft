    ...
    <style type="text/css">
        ...
        #stock_detail_ul {
            ...
            #stock_detail_ul li {
                ...
                #stock_detail_ul li:not(:last-child) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        if ("<%=showType%>" == "2") {
            ...
            $(".nav-btns li[data-item='mdbc']").text("产品亮点介绍");
    ...
    <script type="text/html" id="stock_detail_temp">
        <li class="floatfix">
            <div class="ckmc {{islocal}}">{{ckmc}}</div>
            <div class="sl {{islocal}}">{{sl}}</div>
        </li>
    </script>
...
//        }
    ...
    function myGoodsDeatil(obj) {
        if (typeof(obj)!="string") { //有正确返回 
            ...
            if (obj.rows[0]["qsreport"] !="")   htmlTemp += "<a class='zjbg' href='#'>质检报告 <i class='fa fa-angle-right'></i></a>";
                    ...
                    if(res!=""){
                        ...
                        for(var i=0;i<data.RowTitle.length;i++){                            
                            ...
                            for(var j=0;j<data.ColumnTitle.length;j++){
                                if("<%=RoleName%>"=="dg"){
                                    if(parseInt(data["Row"+(i+1)][j])==0)
                                        if(j==2 && i<data.RowTitle.length-1)
                                            html+="<td class='cmdm' onclick='stockDetail(\""+data.RowTitle[i]+"\",this)'>-</td>";
                                        else
                                            html+="<td>-</td>";
                                    else
                                        if(j==2 && i<data.RowTitle.length-1)
                                            html+="<td class='cmdm' onclick='stockDetail(\""+data.RowTitle[i]+"\",this)'>有</td>";
                                        else
                                            html+="<td>有</td>";
                                }else{
                                    if(j==2 && i<data.RowTitle.length-1)
                                        html+="<td class='cmdm' onclick='stockDetail(\""+data.RowTitle[i]+"\",this)'>"+data["Row"+(i+1)][j]+"</td>";
                                    else
                                        html+="<td>"+data["Row"+(i+1)][j]+"</td>";
                                }                                    
                            }//end for
                            html+="</td></tr>";
                        }//end for rowtitle
