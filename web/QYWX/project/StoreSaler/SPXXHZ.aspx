...
<script runat="server">
    ...
    public string KhClassOptionCollect = ""; //开发编号
    ...
    protected void Page_PreRender(object sender, EventArgs e)
    {
        ...
        else if (roleID < 3 && roleID > 0)
        {
            ...
            {
                object objmdKhid = "";
                string strSQL = string.Concat(@"SELECT TOP 1 CONVERT(VARCHAR(10),a.khid) + '|' + a.mdmc +'|'+convert(varchar(10),kh.ssid)
    ...
    public void SeasonCollect()
    {
        string dbConn = clsConfig.GetConfigValue("OAConnStr");
        using (LiLanzDALForXLM dal = new LiLanzDALForXLM(dbConn)) {
            string _sql = "select top 8 dm,mc from yf_t_kfbh where jzrq is not null order by dm desc";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="page page-right" id="fiterpage">
            <div class="filtercontainer">
                ...
                <div class="farea floatfix" filter="kfbh">
                    ...
                    <!--<div class="fitem" dm="" style="height:60px;line-height:44px;">全部..</div>-->
                ...
                <div class="farea" style="border-top: 1px solid #e2e2e2; margin-bottom: 15px;">
                    <p class="title">日期范围 <i class="fa fa-check-square active" id="rq-switch"></i></p>
    ...
    <script id="datali_1" type="text/html">
        <li khid="{{khid}}" khfl="{{khfl}}">
            <p class="data-item col4 underline" col="khmc">{{khdm}}.{{if khjc == ""}}{{khmc}}{{else}}{{khjc}}{{/if}}</p>
    ...
    <script id="datali_2" type="text/html">
        <li mdid="{{khid}}">
            <p class="data-item col4 underline">{{khmc}}</p>
            <p class="data-item num" col="ddsl">{{ddsl}}</p>
            <p class="data-item" col="xssl">{{xssl}}</p>
            <p class="data-item" col="wcl">{{wcl}}</p>
        </li>
    </script>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#rq-switch").addClass("active");

            if ($("#rq-switch").hasClass("active")) {
                filter.ksrq = $("#ksrq").val();
                filter.jsrq = $("#jsrq").val();
            }
                                ...
                                $.ajax({
                                    ...
                                    success: function (msg) {
                                        if (msg == "1") {
                                            ...
                                            frame.src = "goodsListV7.aspx?showType=1&sphh=" + sphh;
                                            ...
                                            window.location.href = "goodsListV7.aspx?showType=1&sphh=" + sphh;
                                        $("#leemask").hide();
                                    },
                                    error: function (XMLHttpRequest, textStatus, errorThrown) {                                        
                                        LeeJSUtils.showMessage("error", "网络连接失败！");                                        
            ...
            $.ajax({
                ...
                success: function (msg) {
                    ...
                    if (msg.indexOf("Error:") == -1 && msg != "") {
                        ...
                        $("#md .data-ul li:not(:first-child)>.col4").bind("click", function () {
                            filter.lx = "lb";
        ...
        function ResetFilter() {
            ...
            $("div[filter='kfbh'] .fitem.selected").removeClass("selected");
            $("div[filter='zmdfl'] .fitem.selected").removeClass("selected");
            //            $("div[filter='kfbh'] .fitem[dm='']").addClass("selected");
            $("div[filter='kfbh'] .fitem").eq(0).addClass("selected");
        }
        ...
        function SubmitFilter() {
            ...
            filter.zmdfl = zmdfl == undefined ? "" : zmdfl;
        ...
        function gotoSearch() {
            ...
            if (roleID == "4") {
                if (ssid != "1" && ssid != "") {
                    if (filter.lx == "kh") filter.lx = "md"; 

                    filter.khid = ssid;
                    filter.curkhid = ssid;
                    filter.mdid = $("#comlist").val();
                } else if (ssid == "1") {
                    filter.curkhid = $("#comlist").val();
                    filter.khid = filter.curkhid;
                    if (CurrentSite != "md")
                        filter.mdid = "";
                }
            }
            ...
            if ($("div[filter='zmdfl'] .fitem.selected").length != 0)
                filterStr += " 专卖店类别："+ $("div[filter='zmdfl'] .fitem.selected").text();
