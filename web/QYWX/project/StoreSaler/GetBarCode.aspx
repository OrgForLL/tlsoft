...
<script runat="server">
    ...
    {
        string mycode = Convert.ToString(Request.Params["code"]);
        ...
        _Code.Magnify = 1;//放大倍数
        //_Code.ValueFont = new Font("宋体", 20);        
        System.Drawing.Image image = _Code.GetCodeImage(mycode, Code128.Encode.Code128A);
    ...
    public class Code128 : IDisposable
    {
        private DataTable m_Code128 = new DataTable();
        private uint m_Height = 80;
        /// <summary>
        /// 高度
        /// </summary>
