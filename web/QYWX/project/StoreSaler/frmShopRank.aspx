...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container" style="filter:alpha(opacity=90); -moz-opacity:0.90; opacity:0.90;">    
            <div class="tab-nav">
                ...
                <a href="javascript:" onclick="switchView(this,'4')" class="nav-item" order="3"><span>上 月</span></a>
        ...
        <div class="viplist"> 
            <ul class="vipul Active" id="shop0">正在加载本店排行... 请稍候...</ul>
            <ul class="vipul" id="shop1">正在加载本店上月排行.. 请稍候...</ul>
            <ul class="vipul" id="area0">正在加载区域排行... 请稍候...</ul>
            <ul class="vipul" id="area1">正在加载区域上月排行... 请稍候...</ul>
            <ul class="vipul" id="province0">正在加载全省排行... 请稍候...</ul>
            <ul class="vipul" id="province1">正在加载全省上月排行... 请稍候...</ul>            
            <ul class="vipul" id="all0">正在加载全国排行... 请稍候...</ul>
            <ul class="vipul" id="all1">正在加载全国上月排行... 请稍候...</ul>
             
            <ul class="vipul" id="shop2">正在加载本店今日排行... 请稍候...</ul>
            <ul class="vipul" id="shop3">正在加载本店昨日排行.. 请稍候...</ul>
            <ul class="vipul" id="area2">正在加载区域今日排行... 请稍候...</ul>
            <ul class="vipul" id="area3">正在加载区域昨日排行... 请稍候...</ul>
            <ul class="vipul" id="province2">正在加载全省今日排行... 请稍候...</ul>
            <ul class="vipul" id="province3">正在加载全省昨日排行... 请稍候...</ul>            
            <ul class="vipul" id="all2">正在加载全国今日排行... 请稍候...</ul>
            <ul class="vipul" id="all3">正在加载全国昨日排行... 请稍候...</ul>
        </div>
    </div>
