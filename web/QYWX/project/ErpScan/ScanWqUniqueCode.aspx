        ...
        function mysave() {
            ...
            if (serinfo.length > 0 && serinfo.length > 16) {  //serinfo:唯一码
                ...
                if (checkInfo.result == "Successed") {
                    ...
                    if(checkInfo.jsonsObject=="ISuccessed"){
                        document.getElementById("ysml").value = Number(document.getElementById("ysml").value)+1;
                    }
                    scan();
                } else if (checkInfo.result == "Error") {
                    swal({
    ...
    <form id="form1" runat="server">
        ...
        <div class="wrap-page">
            <div id="pagescan" class="page">
                ...
                <div class="input-group input-group-lg" style="margin-bottom: 5px;">
                    <span class="input-group-addon">已刷码:</span>
                    <input type="text" class="form-control" id="ysml" value="0" readonly>
                </div>
