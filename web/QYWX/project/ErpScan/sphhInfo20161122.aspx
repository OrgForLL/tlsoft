            ...
            for(var k=0;k<checkInfos.length;k++){
                ...
                if(水洗名称=="水洗牛仔裤" || 水洗名称=="水洗牛仔裤v2"){
                    ...
                    for (var i = 0; i < 纤维含量.split("|").length; i++) {
                        if(纤维含量.split("|")[i]!=""){
                            var str=纤维含量.split("|")[i].split(":")[1].split(" ");
                            rows+=row1.replace("@mc",纤维含量.split("|")[i].split(":")[0]).replace("@value","");
                            if(str.length>=0){                      
                                for (var j = 0; j < str.length; j++) {
                                    if(str[j]!=""){
                                        rows+=row1.replace("@mc","").replace("@value",str[j]);
                                    }
                                }
                            }
                        }
                    ...
                    if(图标!=""){
                        ...
                        for (var i = 0; i < xdtb.length; i++) {
                            if(xdtb[i]!=""){
                                ...
                                rows+=row1.replace("@mc","<img style='width:3mm' src='../../../" + str[0] + "' />").replace("@value",str[1]);
                            }
                        }
                    }                                     
                    ...
                    if(简化图标!=""){
                        ...
                        for (var i = 0; i < xdtb.length; i++) {
                            if(xdtb[i]!=""){
                                rows+=row1.replace("@mc","<img style='width:3mm' src='../../../" + xdtb[i] + "' />").replace("@value","");
                            }
                        }
                    }  
