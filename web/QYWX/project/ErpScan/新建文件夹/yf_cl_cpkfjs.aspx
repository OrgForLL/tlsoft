    ...
    <script type="text/javascript">    
        ...
        */
        ...
        function ajaxSubmit(key, yphh,bcbs,fzid,username) {
            var subData = { key: key, bcbs: bcbs, fzid: fzid, yphh: yphh, userid: document.getElementById("useridVal").value, username: username, xmjlid:xmjlid, bsid: bsid };
        ...
        function getShowHtml(objJson) {
            ...
            if (scanCtrl == "ypcjjs") {
                ...
                showHtml += "</br></br><label style='font-size:20px;'><input name='moban'style='width:20px;height:20px;' checked id='cjazqr' type='radio' checked onclick='bcbs=2,fzid=2' value='' />裁剪组</label>"
                showHtml += "<label style='font-size:20px;'><input style='width:20px;height:20px;' name='moban' id='radiogr' type='radio' onclick='bcbs=1' value='' />个人</label>";
                if (objJson.cjjsbs == 1) {
                ...
                showHtml += "</br></br><label style='font-size:20px;'><input name='moban' style='width:20px;height:20px;' id='wgqrgr' type='radio'  onclick='wgqraz(1)' value='' />个人</label>";
                for (i = 0; i < objJson.num ; i++) {
                    var fz = objJson.fz.split(";");
                    showHtml += "<label style='font-size:20px;'><input name='moban' style='width:20px;height:20px;' id='wgaz' type='radio' onclick='wgqraz(2)' value='" + fz[i] + "' />" + fz[i] + "</label>"
                }
                if (objJson.cjflbs == 1) {
