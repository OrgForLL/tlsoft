...
<head runat="server">
    ...
    <script type="text/javascript">    
        var  userid, scanCtrl, username,index=1;
        ...
        function setWage(msg) {
            ...
            if (msg.indexOf("Error") == -1 && msg != "") {
                ...
                //$("#yggz .data-ul li:not(:first-child)").remove();
                $("#yggz .data-container .u-more-btn").remove();
                ...
                if (len >= 50) {
                    ...
                    ym = index;                                         //获取当前的页码
                    var dqny = $("#ny").val();
                    var tmp = " <div class='u-more-btn'><a href='javascript:GetWageData(&apos;$dqny$&apos;,&apos;$index$&apos;);' id='u-more-btn'>-- 查看更多 --</a></div>";
                    var htmlstr = tmp.replace("$dqny$", dqny).replace("$index$", ym);
                    $("#yggz .data-container").append(htmlstr);
                    index++;
                }else if (len<50){
                    //var lastid = datas.rows[len - 1]["id"];
                    //var dqny = $("#ny").val();
                    var tmp = " <div class='u-more-btn'><a href='#' id='u-more-btn'>-- 没有更多数据咯 --</a></div>";
    ...
    <style type="text/css">
        ...
        .container{width:100%;overflow:hidden ;position: absolute;top: 0;right: 0;bottom: 0;left: 0;}
        ...
        .data-container {position: relative;top: 0px;bottom: 50px;left: 0;width: 1000px;overflow-y: auto;-webkit-overflow-scrolling: touch;overflow-scrolling: touch; }
        ...
        .header {height: 50px;background-color: #ccc;width: 100%;top: 0;left: 0;position: fixed;z-index:500; display: flex;}
        ...
        .ui-mask {position: fixed;top: 0;left: 0;right: 0;bottom: 0;background-color: rgba(0,0,0,0.4);z-index: 2000;display: none;}
        ...
        .weui_navbar_item {position: relative;display: block;-webkit-box-flex: 1;-webkit-flex: 1;flex: 1;padding: 13px 0;text-align: center;font-size: 15px;-webkit-tap-highlight-color: rgba(0, 0, 0, 0);}
        .weui_tab_panel {box-sizing: border-box;height: 100%;padding-bottom: 40px;padding-top:50px; overflow: auto;-webkit-overflow-scrolling: touch;}
        .weui_tabbar {display: -webkit-box;display: -webkit-flex;display: flex;position: fixed;z-index: 500;bottom: 0;width: 100%;background-color: #F7F7FA;}
    </style>
</head>
<body >
    ...
    <div id="gzcx" class="container" style="visibility: hidden;">
        <div class="page js_show">
            <div class="page_bd" style="height: 100%;">
                <div class="weui_tab">
                    <!-- 页面顶部固定显示 属于层级规范中的Navigation（导航层）范畴-->
                    <div class="weui_navbar header" id="header">
                        <div class="user weui_navbar_item">
                            <p id="user"></p>
                        </div>
                        <div class="user ny weui_navbar_item">
                            <p></p>
                        </div>
                        <div class="filterdiv weui_navbar_item">
                            <p onclick="">筛选</p>
                    ...
                    <!-- 页面主题 属于层级规范中的content（内容层）范畴-->
                    <div class="weui_tab_panel" id="yggz">
                        <div class="data-container">
                            <ul class="data-ul floatfix">
                                <li class="item-head fixed">
                                    <p class="data-item col4"  col="id" hidden>编号</p> <!--隐藏元素，虽然隐藏但是依然占有内容宽度-->
                    ...
                    <!-- 页面底部固定显示 属于层级规范中的Navigation（导航层）范畴-->
                    <%--<div class="weui_tabbar" id="foot" style="visibility:hidden">
