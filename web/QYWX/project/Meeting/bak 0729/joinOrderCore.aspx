    ...
    public string SaveBaseInfo(string baseInfoStr)
    {
        ...
        if (baseInfoJson.GetJsonValue("ryid") == "0" || baseInfoJson.GetJsonValue("ryid").Trim() == "")
        {
            mysql = string.Concat(mysql, @"DECLARE @khid varchar(10);
                                    ...
                                    INSERT INTO yx_t_dhryxx(tzid,khid,mdid,dhbh,Cname,PhoneNumber,Sex,IdCard,rygx,rygxqt,zdr,zdrq) VALUES(1,@khid,@mdid,@dhbh,@Cname,@PhoneNumber,@Sex,@IdCard,@rygx,@rygxqt,@zdr,GETDATE());set @id=@@IDENTITY; END ELSE SET @id=0 ;");
        ...
        else
        {
            ...
            mysql = string.Concat(mysql, " UPDATE yx_t_dhryxx set Cname=@Cname,PhoneNumber=@PhoneNumber,Sex=@Sex,IdCard=@IdCard,rygx=@rygx,rygxqt=@rygxqt where id=@ryid;set @id=@ryid ;");
