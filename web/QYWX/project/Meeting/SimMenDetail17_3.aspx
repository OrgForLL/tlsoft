    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            switch (theme) {
                case "autumn":
                    for (var i = 1; i <= 41; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/autumn/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/autumn/p" + i + ".jpg");
                    }
                    break;
            }
            if (html != "") {
        ...
        window.onload = function () {
            if (llApp.isInApp) {
                if (confirm("请确定您是在WIFI状态下查看此画册，以免产生流量费用？")) {
