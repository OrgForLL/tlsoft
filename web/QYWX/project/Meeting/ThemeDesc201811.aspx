    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            switch (theme) {
                case "hydl":
                    for (var i = 1; i <= 30; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201811/hydl/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201811/hydl/p" + i + ".jpg");
                    }                    
                    break;
                case "mbwns":
                    for (var i = 1; i <= 30; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201811/mbwns/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201811/mbwns/p" + i + ".jpg");
                    }                    
                    break;
                case "gd":
                    for (var i = 1; i <= 20; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201811/gd/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201811/gd/p" + i + ".jpg");
                    }
                    break;
                case "qyd":
                    for (var i = 1; i <= 35; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201811/qyd/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201811/qyd/p" + i + ".jpg");
                    }                    
                    break;
                case "shtm":
                    for (var i = 1; i <= 32; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201811/shtm/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201811/shtm/p" + i + ".jpg");
                    }                    
                    break;
            }
        ...
        function loadMusic(theme) {
            ...
            ele.loop = "true";
            ele.autoplay = "true";
            ele.src = "./bgsound/201811/" + theme + ".mp3";
