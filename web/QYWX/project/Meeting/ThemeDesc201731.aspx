    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            switch (theme) {
                case "jsl":
                    for (var i = 1; i <= 29; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201731/jsl/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201731/jsl/p" + i + ".jpg");
                    }                    
                    break;
                case "ssyr":
                    for (var i = 1; i <= 21; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201731/ssyr/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201731/ssyr/p" + i + ".jpg");
                    }                    
                    break;
                case "ssyrf":
                    for (var i = 1; i <= 24; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201731/ssyrf/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201731/ssyrf/p" + i + ".jpg");
                    }                    
                    break;
                case "qyd":
                    for (var i = 1; i <= 27; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201731/qyd/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201731/qyd/p" + i + ".jpg");
                    }                    
                    break;
                case "gd":
                    for (var i = 1; i <= 22; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201731/gd/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201731/gd/p" + i + ".jpg");
                    }                    
                    break;
            }
            loadMusic(theme);
        ...
        function loadMusic(theme) {            
            ...
            ele.id = "bgmusic";
            ele.loop = "true";            
            ele.src = "./bgsound/201731/" + theme + ".mp3";
