...
<body>
    <div class="wrap-page">
        <div class="page" id="index">
            <div class="album_item animated" data-ani="fadeInRight" style="background-image: url(img/201881/thumb_ssdj.jpg); animation-delay: 0.3s;" onclick="javascript:window.location.href='ThemeDesc201881.aspx?theme=ssdj'">
                <div class="txts left animated fadeInUp" style="animation-delay: 2s;">
                    <h1 class="title">度假</h1>
                    <p class="en">HOLIDAY</p>
                </div>
                <div class="mask"></div>
            </div>
            <div class="album_item animated" data-ani="fadeInLeft" style="background-image: url(img/201881/thumb_ssgd.jpg); animation-delay: 0.6s;" onclick="javascript:window.location.href='ThemeDesc201881.aspx?theme=ssgd'">
            ...
            <div class="album_item animated" data-ani="fadeInRight" style="background-image: url(img/201881/thumb_sssc.jpg); animation-delay: 0.9s;" onclick="javascript:window.location.href='ThemeDesc201881.aspx?theme=sssc'">
                <div class="txts left animated fadeInUp" style="animation-delay: 2s;">
                    <h1 class="title">赛车</h1>
                    <p class="en">RACING</p>
                </div>
                <div class="mask"></div>
            </div>
            <div class="album_item animated" data-ani="fadeInLeft" style="background-image: url(img/201881/thumb_ssyyjb.jpg); animation-delay: 1.5s;" onclick="javascript:window.location.href='ThemeDesc201881.aspx?theme=ssyyjb'">
                <div class="txts right animated fadeInUp" style="animation-delay: 2s;">
                    <h1 class="title">音乐酒吧</h1>
                    <p class="en">MUSIC BAR</p>
                </div>
                <div class="mask"></div>
            </div>
            <div class="album_item animated" data-ani="fadeInRight" style="background-image: url(img/201881/thumb_qsw.jpg); animation-delay: 1.8s;" onclick="javascript:window.location.href='ThemeDesc201881.aspx?theme=qsw'">
                <div class="txts left animated fadeInUp" style="animation-delay:2s;">
                    <h1 class="title">轻商务系列</h1>
                    <p class="en">LIGHT BUSINESS</p>
                </div>
                <div class="mask"></div>
            </div>
        </div>
