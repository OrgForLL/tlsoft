...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e) {
        ...
        string ypmc=   Convert.ToString(HttpUtility.UrlDecode( Request.Params["ypmc"]));
        ...
        if (string.IsNullOrEmpty(yphh) == false) filter = string.Concat(filter, string.Format(" and c.yphh like '{0}%'",yphh));

        if (string.IsNullOrEmpty(ypmc) == false) filter = string.Concat(filter, string.Format(" and c.ypmc like '%{0}%'",ypmc));
