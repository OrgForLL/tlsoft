...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (clsWXHelper.CheckQYUserAuth(true))
        {
            ...
            clsSharedHelper.WriteInfo(string.Format("SystemKey={0} tzid={1} mdid={2} RoleID={3} RoleName={4}",
                        SystemKey, Session["tzid"], Session["mdid"], Session["RoleID"], Session["RoleName"]));
        } 
