        ...
        $(document).ready(function () {
            ...
            switch (theme) {
                case "clmj":
                    for (var i = 1; i <= 22; i++) {
                        if (i < 10)
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/clmj/0" + i + ".jpg' /></div>";
                        else
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/clmj/" + i + ".jpg' /></div>";
                    }
                    break;
                case "gaj":
                    for (var i = 1; i <= 19; i++) {
                        if (i < 10)
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/gaj/0" + i + ".jpg' /></div>";
                        else
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/gaj/" + i + ".jpg' /></div>";
                    }
                    break;
                case "gd":
                    for (var i = 1; i <= 28; i++) {
                        if (i < 10)
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/gd/0" + i + ".jpg' /></div>";
                        else
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/gd/" + i + ".jpg' /></div>";
                    }
                    break;
                case "kjgy":
                    for (var i = 1; i <= 19; i++) {
                        if (i < 10)
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/kjgy/0" + i + ".jpg' /></div>";
                        else
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/kjgy/" + i + ".jpg' /></div>";
                    }
                    break;
                case "osjz":
                    for (var i = 1; i <= 19; i++) {
                        if (i < 10)
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/osjz/0" + i + ".jpg' /></div>";
                        else
                            html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='../../res/img/meeting/zhiyin/osjz/" + i + ".jpg' /></div>";
                    }
                    break;
            }
            if (html != "") {
