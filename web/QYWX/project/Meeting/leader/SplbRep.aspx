...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {            
            ...
            LoadKhflList();
            $.ajax({
                url: "SplbReportData.aspx",
                type: "POST",
                data: { ccid: ccid, lx: "splb", orderInfo: "je DESC", ksrq: $("#ksrq").val(), jsrq: $("#jsrq").val(), approve: $("#approve").val(), khfl: "" },
                dataType: "text",
        ...
        function research(type) {            
            ...
            $.ajax({
                url: "SplbReportData.aspx",
                type: "POST",
                data: { ccid: ccid, lx: "splb", orderInfo: myorderInfo, ksrq: $("#ksrq").val(), jsrq: $("#jsrq").val(), approve: $("#approve").val(), khfl: $("#khfl").val() },
                dataType: "text",
                contentType: "application/x-www-form-urlencoded; charset=UTF-8",
                timeout: 60000,
                error: function (XMLHttpRequest, textStatus, errorThrown) {
