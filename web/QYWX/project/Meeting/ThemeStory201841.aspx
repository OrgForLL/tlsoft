...
<body>
    <div class="wrap-page">
        <div class="page" id="index">
            <div class="album_item animated" data-ani="fadeInRight" style="background-image: url(img/201841/thumb_gdjp.jpg); animation-delay: 0.3s;" onclick="javascript:window.location.href='ThemeDesc201841.aspx?theme=gdjp'">
            ...
            <div class="album_item animated" data-ani="fadeInLeft" style="background-image: url(img/201841/thumb_wlzs.jpg); animation-delay: 0.6s;" onclick="javascript:window.location.href='ThemeDesc201841.aspx?theme=wlzs'">
                <div class="txts right animated fadeInUp" style="animation-delay: 2s;">
                    <h1 class="title">未来战士</h1>
                    <p class="en">FUTURE SOLDIER</p>
                </div>
                <div class="mask"></div>
            </div>
