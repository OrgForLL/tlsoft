    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            switch (theme) {
                case "ssdj":
                    for (var i = 1; i <= 31; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201881/ssdj/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201881/ssdj/p" + i + ".jpg");
                    }                    
                    break;
                case "ssgd":
                    for (var i = 1; i <= 22; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201881/ssgd/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201881/ssgd/p" + i + ".jpg");
                    }                    
                    break;
                case "sssc":
                    for (var i = 1; i <= 25; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201881/sssc/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201881/sssc/p" + i + ".jpg");
                    }
                    break;
                case "ssyyjb":
                    for (var i = 1; i <= 25; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201881/ssyyjb/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201881/ssyyjb/p" + i + ".jpg");
                    }                    
                    break;
                case "qsw":
                    for (var i = 1; i <= 17; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201881/qsw/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201881/qsw/p" + i + ".jpg");
                    }
                    break;
            }
        ...
        function loadMusic(theme) {
            ...
            ele.loop = "true";
            ele.autoplay = "true";
            ele.src = "./bgsound/201881/bg_" + theme + ".mp3";            
