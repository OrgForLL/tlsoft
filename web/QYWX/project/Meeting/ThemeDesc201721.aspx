    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            switch (theme) {
                case "dh":
                    for (var i = 1; i <= 30; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201721/dh/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201721/dh/p" + i + ".jpg");
                    }
                    break;
                case "gdjp":
                    for (var i = 1; i <= 30; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201721/gdjp/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201721/gdjp/p" + i + ".jpg");
                    }
                    break;
                case "ld":
                    for (var i = 1; i <= 26; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201721/ld/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201721/ld/p" + i + ".jpg");
                    }
                    break;
                case "mxt":
                    for (var i = 1; i <= 21; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201721/mxt/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201721/mxt/p" + i + ".jpg");
                    }
                    break;
                case "qyd":
                    for (var i = 1; i <= 23; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201721/qyd/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201721/qyd/p" + i + ".jpg");
                    }
                    break;
            }
            if (html != "") {
