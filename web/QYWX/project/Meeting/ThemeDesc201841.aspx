...
<body>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var imgHead = "http://tm.lilanz.com/qywx/project/meeting/";
            switch (theme) {
                case "gdjp":
                    for (var i = 1; i <= 21; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201841/gdjp/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201841/gdjp/p" + i + ".jpg");
                    }                    
                    break;
                case "wlzs":
                    for (var i = 1; i <= 43; i++) {
                        html += "<div class='swiper-slide'><img class='center-translate swiper-lazy' data-src='img/201841/wlzs/p" + i + ".jpg' /></div>";
                        picArr.push(imgHead + "img/201841/wlzs/p" + i + ".jpg");
                    }                    
                    break;
            }
        ...
        function loadMusic(theme) {
            ...
            ele.loop = "true";
            ele.autoplay = "true";
            ele.src = "./bgsound/201841/bg_" + theme + ".mp3";            
