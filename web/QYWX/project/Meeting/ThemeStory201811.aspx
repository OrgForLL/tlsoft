...
<body>
    <div class="wrap-page">
        <div class="page" id="index">
            <div class="album_item animated" data-ani="fadeInLeft" style="background-image: url(img/201811/thumb_qyd.jpg); animation-delay: 0.3s;" onclick="javascript:window.location.href='ThemeDesc201811.aspx?theme=qyd'">
            ...
            <div class="album_item animated" data-ani="fadeInRight" style="background-image: url(img/201811/thumb_shtm.jpg); animation-delay: 0.6s;" onclick="javascript:window.location.href='ThemeDesc201811.aspx?theme=shtm'">
                <div class="txts left animated fadeInUp" style="animation-delay:2s;">
                    <h1 class="title">深海探秘</h1>
                    <p class="en">DEEP SEA</p>
                </div>
                <div class="mask"></div>
            </div>
            <div class="album_item animated" data-ani="fadeInLeft" style="background-image: url(img/201811/thumb_hydl.jpg); animation-delay:0.9s;" onclick="javascript:window.location.href='ThemeDesc201811.aspx?theme=hydl'">
                <div class="txts right animated fadeInUp" style="animation-delay:2s;">
                    <h1 class="title">寰宇地理</h1>
                    <p class="en">GEOGRAPHY</p>
                </div>
                <div class="mask"></div>
            </div>
            <div class="album_item animated" data-ani="fadeInRight" style="background-image: url(img/201811/thumb_mbwns.jpg); animation-delay: 1.2s;" onclick="javascript:window.location.href='ThemeDesc201811.aspx?theme=mbwns'">
                <div class="txts left animated fadeInUp" style="animation-delay:2s;">
                    <h1 class="title">漫步威尼斯</h1>
                    <p class="en">VENICE</p>
                </div>
                <div class="mask"></div>
            </div>
            <div class="album_item animated" data-ani="fadeInLeft" style="background-image: url(img/201811/thumb_gd.jpg); animation-delay: 1.5s;" onclick="javascript:window.location.href='ThemeDesc201811.aspx?theme=gd'">
                <div class="txts right animated fadeInUp" style="animation-delay:2s;">
