...
<body>
        ...
        <div class="gcontainer">
            ...
            <div class="wrapper">
                ...
                <div class="tips">
                    ...
                    <div class="remark">
                        <p>1、本次活动有效期：2016年9月1日至2016年9月29日；活动地点：天津市和平区滨江道143号光明影院一楼。本次活动主要针对天津地区用户；</p>
                        <p>2、兑换有效期：2016.09.30-2016.10.09；</p>
                        <p>3、活动期间各个奖项奖品数量有限，领完即止；</p>
                        <p><strong>4、中奖者请于16年9月30日至10月9日期间，关注利郎轻商务公众号后，本人凭【找乐】-【最新活动】菜单中的二维码到店（天津市和平区滨江道143号光明影院一楼）领取（二维码截图无效），逾期未领奖者将当成自动放弃中奖资格；</strong></p>
                        <p><strong>5、增加游戏次数方法：如果您是使用微信身份登陆，您可以点击右上角'…'图标，选择【发送给朋友】、【分享到朋友圈】、【分享到手机QQ】、【分享到QQ空间】即可获取游戏机会，每天四次。同时您也可以登陆后单击页面上【我要分享】按钮，让你的好友扫描，当有新用户通过您分享的链接玩游戏时，每吸引到一个新用户您都会增加一次游戏次数；</strong></p>
                        <p>6、店铺地址：天津市和平区滨江道143号光明影院一楼。预计10月1日正式开业，如有疑问请咨询：022-83219627；</p>
                        <p>7、您可以微信搜索【利郎轻商务】公众号，关注后可第一时间获取最新资讯及游戏相关动态；</p>
                        <p>8、奖品图片仅供参考，具体请以实物为准；</p>
                        <p><strong>9.本活动最终解释权归利郎（中国）有限公司所有！</strong></p>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        function MyPrizeList() {
            ...
            $("#message-content .title").text("请您关注【利郎轻商务】公众号后点击菜单【找乐】-【最新活动】进行查看！");
            $("#share-qrcode").hide();
            $(".mask").hide();
            $("#qsw_qrcode").show();
            $("#message").show();
