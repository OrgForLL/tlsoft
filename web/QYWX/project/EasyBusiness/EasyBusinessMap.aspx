...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string StoreIndex = Convert.ToString(Request.Params["StoreIndex"]);
        if (StoreIndex == "" || StoreIndex == null) StoreIndex = "1";
        
        switch (StoreIndex)
        {
            case "0":
                StoreName = "晋江长兴路轻商务展厅";
                StoreAddress = "福建省泉州晋江市长兴路200号"; 
                LilanzLat = 24.795510;
                LilanzLng = 118.571416;
                break;
            case "1":
                StoreName = "天津市和平区滨江道店（筹备中）";
                StoreAddress = "天津市和平区滨江道143号店";
                LilanzLat = 39.126560;
                LilanzLng = 117.201400;
                break;
            case "2":
                StoreName = "利郎大兴龙湖购物中心店（筹备中）";
                StoreAddress = "北京市大兴龙湖购物中心";
                LilanzLat = 39.687490;
                LilanzLng = 116.320490;
                break;
            case "3":
                StoreName = "利郎九龙湖大道万达室内步行街店";
                StoreAddress = "江西南昌市九龙湖区九龙湖大道万达室内步行街";
                LilanzLat = 28.581140;
                LilanzLng = 115.788720;
                break;
            case "4":
                StoreName = "宁波环球城广场室内步行街（筹备中）";
                StoreAddress = "浙江宁波市鄞州区天童南路环球城三楼";
                LilanzLat = 29.797200;
                LilanzLng = 121.546250;
                break;
            case "5":
                StoreName = "上海松江区申越广场店（筹备中）";
                StoreAddress = "上海市松江区中山中路265-383号申越广场";
                LilanzLat = 31.006340;
                LilanzLng = 121.228370;
                break;
        }
