...
<head runat="server">
    ...
    <style type="text/css">
        ...
        #index {
            ...
            background-image:url(img/myprizebg.jpg);
        }
        ...
        .lh {
            ...
            .lh > span {
                ...
                width: 100%;
                display: inline-block;
                border-bottom: 1px dashed #f2b1c5;
            }
...
<body>
    <div class="wrap-page">
        <div class="page" id="index">            
            <div class="title_div">
                <img src="img/myprize_title.png" />
            </div>
            <!--领奖信息-->
            <div class="btn_wrap" style="margin-bottom: 0; font-size: 18px;">
            ...
            <div class="getinfo">
                <div style="width: 100%; padding: 10px 15px; border-radius: 4px;background-color:#fff;">
                    ...
                    <p class="remark">1、请本人持上方二维码至离您最近的利郎轻商务门店领取，配饰品不参与活动！！</p>                           
