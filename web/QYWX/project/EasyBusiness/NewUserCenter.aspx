...
<head runat="server">
    ...
    <style type="text/css">
        ...
        .menu_icon {
            ...
            height: 10vw;
            margin: 0 auto;
            background-image: url(../../res/img/easybusiness/index_icon2.png);
        }
...
<body>
    <!--顶部视窗-->
    <div class="top_view">
        <img src="../../res/img/easybusiness/config.png" class="icon_config" onclick="javascript:window.location.href='MyInfos.aspx'" />
        ...
        <div class="location">
            <img src="../../res/img/easybusiness/location.png" class="icon_location" />
            <span><%=VI["wxpro"].ToString()+" "+VI["wxcity"].ToString() %></span>
        </div>
        <div class="icon_sign back-img" style="background-image: url(../../res/img/easybusiness/icon_sign.png)" onclick="signPerDay();"></div>
        <div class="top_info">
            <ul class="floatfix">
                <li>
    ...
    <div class="myorder" onclick="javascript:window.location.href='ConsumeQuery.aspx'">
        <img src="../../res/img/easybusiness/icon_order.png" class="icon_order" />
        <span>我的订单</span>
        <div class="lookmore">
...
<%--            <li class="nav_item">
            ...
            <li class="nav_item">
                <a href="http://tm.lilanz.com/lspx/redeem.html?act=redirect">
    ...
    <script type="text/ecmascript">
        ...
        window.onload=function(){
         if( "<%=Convert.ToString(VI["cname"])%>" ==""){
               setTimeout( $(".icon_config").click(),50);
            }
        }
