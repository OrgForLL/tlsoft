...
<html>
<script runat="server"> 
    public string wxHeadimgurl = "../../res/img/initial_img.png";
...
<body>
    <div class="wrap-page">
        <div class="logo">
            <div class="logodiv"><img src="../../res/img/EasyBusiness/lilanzlogo.jpg" alt="" /></div>
        </div>
        <div class="headimg">
        ...
        <div class="btns">
            <div class="btn-item animated bounceIn" onclick="window.location.href='vipBinging.aspx'">我已经是会员</div>
            <div class="btn-item animated bounceIn delay" onclick="window.location.href='vipInfoReg.aspx'">申请成为会员</div>
            <div class="hints">
                <div class="title">
                    <div class="line"></div>
                    <p class="hh">温馨提示</p>
