...
function(n) {
	function t() {
		n[s].glbl || (d = {
			...
			$html: n("html"),
			$body: n("body")
		}, a = {}, l = {}, r = {}, n.each([a, l, r], function(e, n) {
			n.add = function(e) {
				e = e.split(" ");
			...
			return e + ".mm"
		}, r.add("transitionend webkitTransitionEnd mousedown mouseup touchstart touchmove touchend click keydown"), n[s]._c = a, n[s]._d = l, n[s]._e = r, n[s].glbl = d)
	}
	var s = "mmenu",
		i = "5.1.2";
	if (!n[s]) {
		n[s] = function(e, n, t) {
		...
		}, n[s].version = i, n[s].addons = {}, n[s].uniqueId = 0, n[s].defaults = {
			extensions: [],
			onClick: {
				setSelected: !0
			},
			...
			_initPanels: function(e) {
				...
				this.__refactorClass(r, this.conf.classNames.vertical, "vertical"), this.opts.slidingSubmenus || r.addClass(a.vertical), r.each(function() {
					...
					var l = e.attr("id");
					e.removeAttr("id"), s.attr("id", l || t.__getUniqueId()), e.hasClass(a.vertical) && (e.removeClass(t.conf.classNames.vertical), s.add(s.parent()).addClass(a.vertical)), i = i.add(s);
				...
				i.each(function() {
					...
					if (!e.children("." + a.navbar).length && !t.hasClass(a.vertical)) {
						...
						if (t.length) {
							var i = t.attr("id");
							e.prepend('<div class="' + a.navbar + '"><a class="' + a.btn + " " + a.prev + '" href="#' + i + '" data-target="#' + i + '"></a><a class="' + a.title + '">' + s.text() + "</a></div>"), e.addClass(a.hasnavbar)
						}
					}
				});
			...
			_initAnchors: function() {
				var e = this;
				d.$body.on(r.click + "-oncanvas", "a[href]", function(t) {
					var i = n(this),
						l = !1,
					...
					if (l && t.preventDefault(), !l && r && i.is("." + a.listview + " > li > a") && !i.is('[rel="external"]') && !i.is('[target="_blank"]')) {
						...
						u && t.preventDefault(), e.__valueOrFn(e.opts.onClick.blockUI, i, !u) && d.$html.addClass(a.blocking), e.__valueOrFn(e.opts.onClick.close, i, u) && e.close()
					}
				})
			},
			_initAddons: function() {
				for (var e in n[s].addons) n[s].addons[e].add.call(this), n[s].addons[e].add = function() {};
			...
			__transitionend: function(e, n, t) {
				...
				e.one(r.transitionend, i), e.one(r.webkitTransitionEnd, i), setTimeout(i, 1.1 * t)
			},
			__getUniqueId: function() {
				return a.mm(n[s].uniqueId++)
			}
		}, n.fn[s] = function(e, i) {
			return t(), e = n.extend(!0, {}, n[s].defaults, e), i = n.extend(!0, {}, n[s].configuration, i), this.each(function() {
				var t = n(this);
				if (!t.data(s)) {
					var a = new n[s](t, e, i);
					t.data(s, a.__api())
...
function(e) {
	...
	e[n].addons[t] = {
		setup: function() {
			var c = this,
				l = this.opts[t];
			this.conf[t], i = e[n].glbl, "undefined" != typeof l && (l instanceof Array || (l = [l]), e.each(l, function(o) {
				var d = l[o];
				"boolean" == typeof d && d && (d = {}), "object" != typeof d && (d = {}), "undefined" == typeof d.content && (d.content = ["prev", "title", "next"]), d = e.extend(!0, {}, e[n].defaults[a], d);
				...
				if (d.content instanceof Array) {
					for (var v = e("<div />"), p = 0, u = !1, m = !1, b = 0, C = d.content.length; C > b; b++) {
						...
						case "next":
						case "close":
							h.addClass(s.hasbtns), v.append('<a class="' + s[d.content[b]] + " " + s.btn + '" href="#"></a>');
							break;
						case "title":
							p++, v.append('<a class="' + s.title + '"></a>');
							break;
						default:
							d.content[b] instanceof e || (d.content[b] = e(d.content[b])), c.__findAddBack(d.content[b], "a").each(function() {
								p++, v.append(e(this))
							})
						}
					}
					p > 1 && h.addClass(s.navbar + "-" + p), v = v.html()
				} else var v = d.content;
				if (h.prependTo(c.$menu).append(v), c.$menu.addClass(s.hasnavbar + "-" + f), m && (c.$menu.addClass(s.hasnavbar), c.bind("init", function(e) {
					...
					var x = h.find("." + s.title),
						...
						N = function(e) {
							...
							x[p ? "attr" : "removeAttr"]("href", p), x[o ? "removeClass" : "addClass"](s.hidden), x.html(o), k[h ? "attr" : "removeAttr"]("href", h), k[h || u ? "removeClass" : "addClass"](s.hidden), k.html(u), y[v ? "attr" : "removeAttr"]("href", v), y[v || m ? "removeClass" : "addClass"](s.hidden), y.html(m)
						};
					if (c.bind("openPanel", N), c.bind("init", function() {
						N.call(c, c.$menu.children("." + s.current))
					}), c.opts.offCanvas) {
						var $ = function(e) {
								A.attr("href", "#" + e.attr("id"))
							};
						$.call(c, i.$page), c.bind("setPage", $)
					}
				}
			}))
		},
		add: function() {
			s = e[n]._c, r = e[n]._d, c = e[n]._e, s.add("close hasbtns")
		},
		clickAnchor: function() {}
	}, e[n].defaults[a] = {
		position: "top",
		title: "LILANZ 2015 秋季陈列手册",      //修改菜单名称 LILANZ 2015 秋季陈列手册
		titleLink: "panel"
